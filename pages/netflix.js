...
const netflix = () => {
    return ( 
        ...
        <title>Nash-Profile | Netflix</title>
                ...
                <div className="p-2">
                    <p className=" text-center font-bold pb-2">Technology</p>
                        <div className="grid grid-cols-3 md:grid-cols-1">
                            ...
                            <p className="py-2 flex items-center"><RiRadioButtonFill className="pr-1" /> IMDB API</p>
                        </div>
                </div>
            </div>
        </div>
